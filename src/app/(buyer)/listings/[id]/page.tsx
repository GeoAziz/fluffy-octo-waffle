...
export default async function ListingDetailPage({
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8 md:py-12 pb-32 md:pb-12">
          ...
          <Card className="overflow-hidden">
            <CardHeader className="p-0 relative">
              ...
              <div className="absolute top-3 left-3 z-10">
                <FavoriteButton listingId={id} className="h-11 w-11 md:h-8 md:w-8" />
              </div>
            ...
            <CardContent className="p-6">
              <div className="mb-4 flex flex-wrap items-start justify-between gap-4">
                ...
                {isOwner && (
                  <Badge variant="secondary" className="h-7 px-3 gap-1.5 font-black uppercase text-[10px]">

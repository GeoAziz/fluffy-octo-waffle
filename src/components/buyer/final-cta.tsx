...
/**
 * FinalCta - Full-width gradient section to drive final conversion
 */
      ...
      <div className="container relative z-10 mx-auto max-w-4xl px-4 text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Button 
            size="lg" 
            asChild 
            className="h-14 w-full bg-white px-10 text-[11px] font-black uppercase tracking-widest text-primary hover:bg-emerald-50 sm:w-auto shadow-2xl"
          >
            <Link href="/explore">
              Browse All Listings
          ...
          <Button 
            ...
            variant="ghost" 
            asChild 
            className="h-14 w-full border border-white/20 text-white hover:bg-white/10 sm:w-auto text-[11px] font-black uppercase tracking-widest"
          >
